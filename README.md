# LUV NFT BITCOIN  - Open Ordinals Decentralized Exchange

LUV NFT BITCOIN is an open source zero-fee trustless Bitcoin NFT marketplace based on partially signed bitcoin transactions
